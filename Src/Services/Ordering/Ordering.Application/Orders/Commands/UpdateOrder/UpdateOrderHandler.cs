    ...
    : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    ...
    public void UpdateOrderWithNewValues(Order order, OrderDto orderDto)
    {
        ...
        var updatedPayment = Payment.Of(orderDto.Payment.CardName, orderDto.Payment.CardNumber, orderDto.Payment.Expiration, orderDto.Payment.Cvv2, orderDto.Payment.PaymentMethod);
